...
import abtlibrary.utils.anibisApiClient.auth.ApiKeyAuth;
import abtlibrary.utils.anibisApiClient.auth.Authentication;
import abtlibrary.utils.anibisApiClient.auth.HttpBasicAuth;
...
//    setUserAgent("Java-Swagger");
    setUserAgent("ch.anibis.anibis.alpha/3.0.1 (Android 5.1, XXHDPI, AndroidSimulator)");
    ...
    addDefaultHeader("X-Token", XTokenGenerator.getToken());
    addDefaultHeader("X-Udid", XTokenGenerator.getUdid());
    addDefaultHeader("X-Xbase-Api-Key", XTokenGenerator.getApiKey());
    addDefaultHeader("X-Xbase-Api-Version", "1.0");
    addDefaultHeader("X-Request-Date", XTokenGenerator.generatedTime);
