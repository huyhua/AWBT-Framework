...
public class SelectElement extends RunOnFailureKeywordsAdapter {
	...
	public void selectFromList(String locator, String... items) {
		...
		if (nonExistingItems.size() != 0) {
			...
			if (select.isMultiple()) {
				throw new ABTNonFatalException(String.format("Options '%s' not in list '%s'.",
			...
			if (!lastItemFound) {
				throw new ABTNonFatalException(String.format("Option '%s' not in list '%s'.",
	...
	public void selectFromListByIndex(String locator, String... indexes) {
		if (indexes.length == 0) {
			throw new ABTNonFatalException("No index given.");
		}
	...
	public void selectFromListByValue(String locator, String... values) {
		if (values.length == 0) {
			throw new ABTNonFatalException("No value given.");
		}
